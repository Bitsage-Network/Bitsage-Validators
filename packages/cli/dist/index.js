...
privacy
    ...
    .action((amount, opts) => privacyCommand("deposit", [amount], opts));
privacy
    .command("withdraw")
    ...
    .action((amount, opts) => privacyCommand("withdraw", [amount], opts));
privacy
    .command("balance")
...
privacy
    ...
    .action((from, to, amount, opts) => privacyCommand("swap", [from, to, amount], opts));
// Logs command
program
    .command("logs")
