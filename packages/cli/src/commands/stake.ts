...
export async function stakeCommand(action: string, amount?: string): Promise<void> {
...
async function handleAddStake(address: string, amountArg?: string): Promise<void> {
  console.log("");
...
async function handleRemoveStake(address: string, amountArg?: string): Promise<void> {
  console.log("");
  console.log(chalk.blue("═══════════════════════════════════════════════════════════════"));
...
async function handleStakeInfo(address: string): Promise<void> {
  console.log("");
  console.log(chalk.blue("═══════════════════════════════════════════════════════════════"));
