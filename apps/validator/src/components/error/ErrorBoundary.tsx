        ...
        if (apiUrl) {
          fetch(`${apiUrl}/api/errors`, {
            ...
            body: JSON.stringify({
              ...
              timestamp: Date.now(),
              network: process.env.NEXT_PUBLIC_STARKNET_NETWORK || "unknown",
            }),
          }).catch(() => {
            // Silently fail — error reporting should never cause additional errors
          });
        }
      } catch {
        // Swallow any reporting failures
      }
    }
  }
