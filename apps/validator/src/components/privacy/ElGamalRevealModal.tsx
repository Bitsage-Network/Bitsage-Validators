            ...
            <div className="relative px-6 py-5 border-b border-white/5">
              ...
              <div className="relative flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-violet-500/30 to-purple-500/30 flex items-center justify-center border border-violet-500/30">
            ...
            <div className="p-6">
                ...
                <div className="space-y-5">
                  <div className="p-4 rounded-xl bg-violet-500/10 border border-violet-500/20">
                    ...
                    <p className="text-sm text-gray-400 leading-relaxed">
                      Your private balance is encrypted using <strong className="text-violet-400">ElGamal homomorphic encryption</strong>.
                  ...
                  <div className="p-4 rounded-xl bg-surface-elevated border border-white/5">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 rounded-full bg-violet-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                          <span className="text-xs text-violet-400">3</span>
                        </div>
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <div className="w-6 h-6 rounded-full bg-violet-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                          <span className="text-xs text-violet-400">4</span>
                        </div>
                        <div>
                  ...
                  <button
                    ...
                    className="w-full py-3.5 rounded-xl bg-gradient-to-r from-violet-500 to-purple-500 hover:from-violet-400 hover:to-purple-400 text-white font-semibold transition-all flex items-center justify-center gap-2 shadow-lg shadow-violet-500/25"
                  >
              ...
              {(step === "awaiting_signature" || step === "deriving_kek" || step === "loading_notes" || step === "decrypting") && (
                <div className="space-y-5">
                  ...
                  {step === "decrypting" && (
                    <div className="p-4 rounded-xl bg-surface-elevated border border-white/5">
                      <h4 className="text-xs text-violet-400 uppercase tracking-wide mb-3">
              ...
              {step === "complete" && result && (
                <div className="space-y-5">
                  <div className="text-center py-4">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-green-500/20 to-violet-500/20 flex items-center justify-center mx-auto mb-4 border border-green-500/30">
                  ...
                  {/* Revealed Balance */}
                  <div className="p-5 rounded-xl bg-gradient-to-br from-green-500/10 to-violet-500/10 border border-green-500/30 text-center">
