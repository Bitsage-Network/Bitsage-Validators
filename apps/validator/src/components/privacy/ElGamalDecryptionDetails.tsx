    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {formula && (
            <div className="p-2 rounded-lg bg-black/30 font-mono text-xs text-violet-400 overflow-x-auto">
              {formula}
            </div>
          )}
          {result && (
...
export function ElGamalDecryptionDetails({
  ...
  return (
    <div className={cn("space-y-4", className)}>
      ...
      <div className="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-green-500/10 to-violet-500/10 border border-green-500/30">
      ...
      <button
        ...
        className="w-full p-3 rounded-xl bg-surface-elevated/50 border border-surface-border hover:border-violet-500/40 transition-colors flex items-center justify-between"
      >
        <div className="flex items-center gap-2">
                ...
                >
                  <div className="p-3 border-t border-surface-border space-y-3">
                    ...
                    <div className="p-2 rounded-lg bg-violet-500/10 border border-violet-500/20 flex items-center justify-between">
                      <span className="text-xs text-violet-400">Recovered Amount (discrete log)</span>
