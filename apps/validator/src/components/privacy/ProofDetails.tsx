...
export function ProofDetails({
  ...
  return (
    <div className={cn("rounded-xl border border-violet-500/30 overflow-hidden", className)}>
      {/* Header - Always visible */}
      <button
        onClick={() => setIsExpanded(!isExpanded)}
        className="w-full p-4 bg-gradient-to-r from-violet-600/10 to-purple-600/10 hover:from-violet-600/20 hover:to-purple-600/20 transition-colors"
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-400">
                Proved in <span className="text-violet-400 font-mono">{provingTimeMs}ms</span> •
                Leaf #{leafIndex}
              </p>
            </div>
          </div>
      ...
      <AnimatePresence>
        {isExpanded && (
          ...
          >
            <div className="p-4 space-y-4 bg-gray-900/50 border-t border-violet-500/20">
              {/* Quick Stats */}
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 p-3 rounded-lg bg-surface-elevated font-mono text-sm">
                  <code className="text-violet-400 flex-1 break-all">{commitment}</code>
                  <button
              ...
              <div className="p-3 rounded-lg bg-gradient-to-r from-violet-500/10 to-violet-500/10 border border-violet-500/20">
                <div className="flex items-start gap-2">
                  <Fingerprint className="w-4 h-4 text-violet-400 mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="text-sm font-medium text-violet-400">Cryptographic Guarantees</p>
...
export function ProofBadge({ provingTimeMs, leafIndex, onClick, className }: ProofBadgeProps) {
  return (
    ...
    >
      ...
      <span className="text-violet-400 font-mono">{provingTimeMs}ms</span>
