  ...
  return (
    <>
      <div className={cn("flex items-center gap-2", className)}>
        <span className={cn(sizeClasses[size], showMasked ? "text-violet-400 font-mono tracking-wider" : "text-white")}>
          {isLoading ? (
              ...
              <div className="space-y-4">
                ...
                <div className="p-3 rounded-lg bg-violet-500/10 border border-violet-500/20">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-xs text-violet-300">
                      ...
                      <p className="mt-1 text-violet-400/80">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 rounded-lg bg-gradient-to-r from-violet-500 to-purple-500 text-white font-medium hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
                  >
...
export function PrivacyModeToggle({
  ...
  return (
    <div className={cn(
      ...
      enabled 
        ? "bg-gradient-to-r from-violet-600/20 to-accent-purple/20 border-violet-500/40" 
    ...
    >
      <div className="flex items-center gap-3">
        <div className={cn(
          ...
          enabled ? "bg-violet-500/30" : "bg-surface-elevated"
        )}>
          {enabled ? (
      ...
      <div className={cn(
        ...
        enabled ? "bg-violet-600" : "bg-surface-border"
      )}>
        <motion.div
          ...
          <div className="group relative">
            ...
            <div className="absolute right-0 top-full mt-2 w-64 p-3 bg-surface-elevated border border-surface-border rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
              <p className="text-xs text-gray-300">
                ...
                <strong className="text-violet-400">Private:</strong> Encrypted with ElGamal. Only you can reveal the actual amount.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="p-4 rounded-xl bg-surface-elevated/50 border border-surface-border">
            ...
            <button
              ...
              className="mt-3 w-full py-2 px-3 rounded-lg bg-violet-600/20 hover:bg-violet-600/30 text-violet-400 text-sm font-medium transition-colors flex items-center justify-center gap-2"
            >
          ...
          <div className="p-4 rounded-xl bg-gradient-to-br from-violet-600/10 to-accent-purple/10 border border-violet-500/30 relative overflow-hidden">
            {/* Encrypted pattern background */}
            <div className="absolute inset-0 opacity-5">
              <div className="text-[8px] font-mono text-violet-400 leading-tight break-all p-2">
            ...
            <div className="relative">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-violet-400 uppercase tracking-wide">Private</span>
                </div>
              ...
              {privateRevealState === "revealed" ? (
                ...
                <div className="mb-1">
                  <p className="text-2xl font-bold text-violet-400 font-mono tracking-widest">•••••••</p>
                  <p className="text-[10px] text-violet-400/50 font-mono mt-1">
              ...
              <div className="p-4 space-y-4">
                ...
                <div className="flex items-center justify-center gap-4 py-4">
                  <div className={cn(
                    ...
                    wrapDirection === "wrap" ? "bg-surface-elevated" : "bg-violet-600/20"
                  )}>
                    {wrapDirection === "wrap" ? (
                      <>
                      ...
                      <>
                        <div className="text-lg font-mono text-violet-400 mb-1">•••</div>
                        <span className="text-xs text-violet-400">Encrypted</span>
                      </>
                    )}
                  </div>
                  ...
                  <div className={cn(
                    "p-4 rounded-xl text-center",
                    wrapDirection === "wrap" ? "bg-violet-600/20" : "bg-surface-elevated"
                  )}>
                    {wrapDirection === "wrap" ? (
                      <>
                        <div className="text-lg font-mono text-violet-400 mb-1">•••</div>
                ...
                <div className={cn(
                  ...
                  <p className="text-xs text-gray-400">
                    {wrapDirection === "wrap" ? (
                      <>
                        <strong className="text-violet-400">🔐 Privacy Protection:</strong> Your balance will be encrypted 
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isProcessing || !amount || parseFloat(amount) <= 0
                      ...
                      : wrapDirection === "wrap"
                        ? "bg-gradient-to-r from-violet-600 to-accent-purple hover:from-violet-500 hover:to-accent-purple/90 text-white"
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 border-b border-surface-border">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-green-500/20 to-violet-500/20 flex items-center justify-center">
  ...
  return (
    <div 
      className={cn(
        ...
        enabled 
          ? "bg-gradient-to-r from-violet-600/15 to-accent-purple/15 border-violet-500/40" 
          : "bg-surface-elevated/50 border-surface-border hover:border-gray-600",
        className
      )}
      onClick={() => onToggle(!enabled)}
