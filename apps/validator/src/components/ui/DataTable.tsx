    ...
    <div className={cn("rounded-xl border border-surface-border overflow-hidden", className)}>
      ...
      <AnimatePresence>
        {selectable && selectedIds.size > 0 && (
          ...
          >
            <div className="flex items-center justify-between gap-4 px-4 py-3 bg-emerald-500/10 border-b border-emerald-500/20">
                  ...
                  {column.sortable !== false && sortable ? (
                    <button
                      ...
                      className={cn(
                        ...
                        sortColumn === column.key && "text-emerald-400",
