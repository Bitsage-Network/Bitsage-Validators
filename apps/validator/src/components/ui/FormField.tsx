        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              ...
              // Normal state
              !error && !success && "border-surface-border focus:border-emerald-500 focus:ring-emerald-500/20",
              // Error state
            ...
            <input
              ...
              className={cn(
                ...
                !error
                  ...
                  : "border-red-500/50",
                "focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:ring-offset-0",
                "disabled:opacity-50 disabled:cursor-not-allowed",
                className
              )}
              {...props}
            ...
            <div className="relative flex items-center">
              ...
              <div
                className={cn(
                  ...
                  value === option.value ? "bg-emerald-600 scale-100" : "bg-transparent scale-0"
                )}
              />
            </div>
            <div className="flex-1">
