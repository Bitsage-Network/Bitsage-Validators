    ...
    return (
      <div
        ...
        className={cn(
          ...
          variants[variant],
          paddings[padding],
          hover && "hover:border-emerald-500/50 hover:shadow-lg hover:shadow-emerald-500/5",
          className
        )}
        {...props}
      >
  ...
  const content = (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        {showArrow && (
          <div className="ml-4 text-gray-500 group-hover:text-emerald-400 transition-colors">
            {external ? (
  ...
  return (
    <Card
      ...
      className={cn(
        ...
        isHighlighted && "border-emerald-500/50",
        className
      )}
    >
      ...
      <div className="relative">
        <div
          className={cn(
            ...
            isHighlighted ? "bg-emerald-500 text-white" : "bg-emerald-500/20 text-emerald-400"
          )}
        >
          {icon}
        </div>
