...
export function ProgressBar({
  ...
  const variants = {
    default: "bg-gray-500",
    brand: "bg-gradient-to-r from-emerald-600 to-emerald-400",
              ...
              <div className="relative">
                <motion.div
                  ...
                  className={cn(
                    ...
                    status === "current" && "border-emerald-500 bg-emerald-500",
...
export function LoadingProgress({
  ...
  if (variant === "spinner") {
    ...
    return (
      <div className={cn("flex items-center gap-3", className)}>
        <Loader2 className={cn("animate-spin text-emerald-400", spinnerSizes[size])} />
  ...
  return (
    <div className={cn("space-y-2", className)}>
      ...
      <div className={cn("w-full rounded-full bg-surface-elevated overflow-hidden", sizes[size])}>
        <motion.div
          className="h-full w-1/3 bg-gradient-to-r from-emerald-600 via-emerald-400 to-emerald-600 rounded-full"
          animate={{ x: ["-100%", "300%"] }}
          transition={{
            duration: 1.5,
            repeat: Infinity,
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-2">
          <span
            className={cn(
              "text-xs font-medium",
              config.color === "brand" && "text-emerald-400",
