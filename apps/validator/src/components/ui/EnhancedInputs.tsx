        ...
        <div className="relative flex items-center">
          <input
            ...
            className={cn(
              ...
              !error
                ? "border-surface-border focus:border-emerald-500 focus:ring-emerald-500/20"
  ...
  return (
    <div className={cn("space-y-2", containerClassName)}>
      ...
      >
        {/* Filled Track */}
        <div
          className="absolute h-full rounded-full bg-gradient-to-r from-emerald-600 to-emerald-400"
        ...
        <motion.div
          className={cn(
            ...
            isDragging && "ring-4 ring-emerald-500/20",
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  mark.value === value ? "text-emerald-400" : "text-gray-500 hover:text-gray-300",
    ...
    <div className={cn("space-y-2", containerClassName)}>
      ...
      <div
        className={cn(
          ...
          "bg-surface-elevated border transition-all duration-200",
          !error
            ? "border-surface-border focus-within:border-emerald-500 focus-within:ring-2 focus-within:ring-emerald-500/20"
