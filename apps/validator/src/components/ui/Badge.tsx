...
interface BadgeProps {
  ...
  variant?: "default" | "success" | "warning" | "error" | "info" | "brand" | "validator" | "obelysk" | "gpu-blackwell" | "gpu-hopper" | "gpu-ampere" | "gpu-ada";
  size?: "sm" | "md" | "lg";
  className?: string;
  dot?: boolean;
  pulse?: boolean;
...
export function Badge({
  ...
  const variants = {
    ...
    obelysk: "bg-violet-500/20 text-violet-400 border-violet-500/30",
    "gpu-blackwell": "bg-lime-500/20 text-lime-400 border-lime-500/30",
    "gpu-hopper": "bg-emerald-500/20 text-emerald-400 border-emerald-500/30",
    "gpu-ampere": "bg-blue-500/20 text-blue-400 border-blue-500/30",
    "gpu-ada": "bg-violet-500/20 text-violet-400 border-violet-500/30",
  };
  ...
  const dotColors = {
    ...
    validator: "bg-amber-400",
    obelysk: "bg-violet-400",
    "gpu-blackwell": "bg-lime-400",
    "gpu-hopper": "bg-emerald-400",
    "gpu-ampere": "bg-blue-400",
    "gpu-ada": "bg-violet-400",
  };
  ...
  return (
    <span
      className={cn(
        ...
        "bg-gradient-to-r from-emerald-500 to-accent-purple text-white",
        className
      )}
    >
      New
