...
export function GettingStartedWizard({
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -10 }}
      className="glass-card p-4 sm:p-6 mb-6 border-emerald-500/30 bg-gradient-to-r from-emerald-600/10 to-accent-purple/10"
    >
      {/* Header */}
      ...
      <div className="mb-4">
        ...
        <div className="h-2 bg-surface-elevated rounded-full overflow-hidden">
          <motion.div
            ...
            className="h-full bg-gradient-to-r from-emerald-500 to-accent-purple rounded-full"
          />
        </div>
      </div>
