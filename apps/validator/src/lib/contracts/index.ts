...
/**
 * Build a ragequit from privacy pool (emergency withdrawal)
 * @param tokenAddress Token to withdraw
 * @param depositIndex Index of the deposit to ragequit
 */
export function buildPrivacyPoolRagequitCall(
  ...
  return {
    contractAddress: addresses.PRIVACY_POOLS,
    entrypoint: "initiate_ragequit",
    calldata: [tokenAddress, depositIndex.toString()],
  };
}

/**
 * Build an execute ragequit transaction (after 24h waiting period)
 * @param tokenAddress Token to withdraw
