  ...
  return {
    jobs: {
      ...
      jobsByType: {
        ...
        "Data Pipeline": 3421,
        "ML Training": 2156,
        "Generic Compute": 2036,
      },
    },
    proofs: {
      totalProofs: 12456,
      verifiedProofs: 12234,
      failedProofs: 222,
      avgGenerationTime: 8500,
      avgVerificationTime: 120,
      proofsByCircuit: {
        PRIVACY_WITHDRAW: 3421,
        PRIVACY_TRANSFER: 2156,
        AI_INFERENCE: 4532,
        GENERIC_COMPUTE: 2347,
      },
      teeProofs: 5577,
      gpuProofs: 6879,
      wasmProofs: 0,
    ...
    earnings: {
      ...
      periodEarned: 4523.8,
      pendingRewards: 892.3,
      claimedRewards: 124538.2,
      projectedMonthly: 15234.6,
      earningsBySource: {
        compute: 85234.3,
        proofs: 28456.2,
        staking: 8956.7,
    ...
    historical: {
      timestamps: Array.from({ length: 24 }, (_, i) => now - (23 - i) * hour),
      jobs: Array.from({ length: 24 }, () => 500 + Math.random() * 200),
      proofs: Array.from({ length: 24 }, () => 400 + Math.random() * 150),
      earnings: Array.from({ length: 24 }, () => 150 + Math.random() * 100),
      utilization: Array.from({ length: 24 }, () => 60 + Math.random() * 30),
    },
  };
}
