        ...
        >
          ...
          {workerEarnings && address && !leaderboard?.some(e => e.address.toLowerCase() === address.toLowerCase()) && (
            <div className="mt-4 pt-4 border-t border-surface-border">
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-brand-600/10 border border-brand-500/30">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center font-bold text-sm bg-brand-500/20 text-brand-400">
                    #{workerEarnings.rank}
                  </div>
                  <div>
                    <p className="text-sm font-mono text-white">
